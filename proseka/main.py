...
contours, hierarchy = cv2.findContours(img_bin, cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE) #img_binaryを輪郭抽出
cv2.drawContours(img_psc, contours, -1, (0,0,255), 1) #抽出した輪郭をcount+=len(contours)赤色でimg_colorに重ね書き
